...
Also note, the CDN address is actually hardcoded into the server in a few spots. You'll need to change the address to match yours. You can see an example on austation's goon fork [here](https://github.com/austation/goonstation/commit/77c1b4b58878c09c0c98![1000627933](https://github.com/user-attachments/assets/68ff2484-ee47-422d-bb84-e2bf5dc7b0db)
c9a2bfd09eea37baba33).
